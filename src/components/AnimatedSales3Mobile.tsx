...
interface AnimatedSales3MobileProps {
  salesCount: number;
  started?: boolean;
}
...
export default function AnimatedSales3Mobile({ salesCount, started = true }: AnimatedSales3MobileProps) {
